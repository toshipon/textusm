...
export class DiagramPanel {
  ...
  public static async createOrShow(
    ...
    const onReceiveMessage = async (message: WebviewMessage) => {
      ...
      } else if (message.command === "exportSvg" && message.text && message.width && message.height) {
    ...
    if (DiagramPanel.activePanel) {
      try {
        ...
        const elmScriptUri = DiagramPanel.activePanel._panel.webview.asWebviewUri(
    ...
    console.log("Elm script exists:", fs.existsSync(path.join(context.extensionPath, "js", "elm.js")));
